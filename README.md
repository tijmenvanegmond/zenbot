...
_"Experience tranquility. Embrace the Iris."_
...
_For complete API documentation, see [CLAUDE.md](./CLAUDE.md)_
...
_"True self is without form... but proper error handling helps."_ - Zen Wisdom for Developers

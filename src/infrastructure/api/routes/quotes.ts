...
export default async function quotesRoutes(fastify: FastifyInstance, { discordClient, orchestrator }: { discordClient: Client, orchestrator?: ZenbotOrchestrator }, done?: Function) {

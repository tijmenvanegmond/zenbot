...
import { Snowflake, Client, Guild, VoiceBasedChannel, Constants, GatewayDispatchEvents, GatewayVoiceServerUpdateDispatchData, GatewayVoiceStateUpdateDispatchData, Events, Status } from 'discord.js';
